...
const MOCK_MESSAGES: ChatMessage[] = [
  { id: "1", user: "System", content: "Welcome to the chatroom!", color: "text-zinc-500", isSystem: true },
  { id: "2", user: "NeonRider", content: "This stream is amazing! 🚀", color: "text-pink-600" },
  { id: "3", user: "CyberPunk", content: "Love the visuals", color: "text-blue-600" },
  { id: "4", user: "Glitch01", content: "Is this real time?", color: "text-green-600" },
  { id: "5", user: "PixelArt", content: "Hello everyone! 👋", color: "text-purple-600" },
]
...
export function StreamChat({ streamId, program }: StreamChatProps) {
  ...
  const handleBuyShares = async (teamId: number) => {
    ...
    try {
        ...
        console.log(`Buying shares: Stream=${streamId}, Team=${teamId}, Amount=${lamports.toString()}`);

        await purchaseShares(program, wallet, new BN(streamId), teamId, lamports)
